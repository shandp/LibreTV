...
function renderDoubanCards(data, container) {
    ...
    if (!data.subjects || data.subjects.length === 0) {
        ...
        data.subjects.forEach(item => {
            ...
            // 乾淨的處理：去掉 http: 或 https:，只留 //img1.doubanio.com/...
            ...
            const noReferrerCoverUrl = `https://images.weserv.nl/?url=${cleanUrl}`;
            ...
            card.innerHTML = `
                <div class="relative w-full aspect-[2/3] overflow-hidden cursor-pointer" onclick="fillAndSearchWithDouban('${safeTitle}')">
                    <img src="${noReferrerCoverUrl}" alt="${safeTitle}" 
                        ...
                        onerror="this.onerror=null; this.src='${noReferrerCoverUrl}'; this.classList.add('object-contain');"
